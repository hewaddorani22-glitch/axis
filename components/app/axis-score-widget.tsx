      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[10px] font-mono uppercase tracking-[0.2em] mb-1" style={{ color: "var(--text-tertiary)" }}>Axis Score</p>
      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
        ...
        <div className="relative flex-shrink-0 flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-0.5">
            ...
            <p className="text-[10px] font-mono uppercase tracking-[0.24em]" style={{ color: "var(--text-tertiary)" }}>Axis Score</p>
          </div>
        </div>
