      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-axis-text3 hover:text-axis-text1 transition-colors">Blog</a></li>
              <li><a href="#" className="text-sm text-axis-text3 hover:text-axis-text1 transition-colors">Changelog</a></li>
              <li><a href="#" className="text-sm text-axis-text3 hover:text-axis-text1 transition-colors">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-axis-text3 hover:text-axis-text1 transition-colors">Privacy</a></li>
              <li><a href="#" className="text-sm text-axis-text3 hover:text-axis-text1 transition-colors">Terms</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-axis-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            <a href="#" className="text-axis-text3 hover:text-axis-text1 transition-colors">
